namespace EFrameworkDz02
{
    ...
    public partial class newEquipment
    {
        ...
        public virtual TablesModel TableModel { get; set; }

        public virtual ICollection<TablesManufacturer> Tab { get; set; }

        public virtual ICollection<TablesModel> TabModel { get; set; }
    }
}
